 ...
 * Time: 15:20
 */
class Admin_User_module extends CI_Module
{
    ...
    {
        $auth_url = [
            'is_add' => 'admin/user/edit',
            'is_edit' => 'admin/user/edit',
            'is_del' => 'admin/user/ajax_remove'
        ];
        ...
        $data['index_url'] = site_url('admin/user/index');
        $data['add_url'] = site_url('admin/user/edit');
        $data["title"] = '用户管理';
...
//        }
        ...
        $arr['ajax_check_name'] = site_url("admin/user/ajax_check_name?id=0");
        if ($id) {
        ...
        $arr['save_url'] = site_url('admin/user/user_save');
        $this->load->view('user/user_edit', $arr);
    }
